...
def all_derivatives(func, in_vars, point):
    ...
    :returns: out_val (scalar) the value of the input function at the input point
              out_dervs (list) a list of the 1st derivative values of each input variable at the input point

    :dependencies: requires class AutoDiff from module AutoDiff
    ...
    return out_val, out_dervs



def multi_func_all_derivatives(functions, in_vars, point):
    '''
    Function that calculates the value of the input functions at the input point and all its partial derivatives
    producing a numpy array of output values and a numpy 2D array of partial derivative (the Jacobian)
    ...
    :dependencies: requires class AutoDiff from module AutoDiff, function all_derivatives from this module,
                            and package numpy imported as np
    ...
    >>> multi_func_all_derivatives([fc,func] , ['x','y'], [3,2])
    (array([13., 36.]), array([[ 6.,  4.],
           [24., 36.]]))
...
a, b = all_derivatives(fc, ['x','y'], [3,2])
print(a, b)
...
a, b = multi_func_all_derivatives([fc, func], ['x','y'], [3,2])
print(a, b)
